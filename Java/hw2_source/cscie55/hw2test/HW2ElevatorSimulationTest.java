...
public class HW2ElevatorSimulationTest
{
    ...
    public void disembark() throws ElevatorFullException
    {
        ...
        // 6 passengers on the 1st floor: 1 will be boarded on the 3rd floor; 
        // 2 will be boarded on the 4th floor; 3 will be boarded on the 6th floor.
    ...
    public void elevatorFull()
    {
        ...
        //System.out.println("waiting passenger "+building.floor(4).passengersWaiting());
